...
> - **Care guides** are now built natively in this repo (**AquaticMotivApp**) at `/` — see Tier 2.
...
- **App / JSON (`/`):** 162 live URLs — 102 plant + 25 invert species, ~31 filter pages, 4 hubs.
