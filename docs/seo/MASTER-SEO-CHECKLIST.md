...
> [`SEO-FIXES.md`](./SEO-FIXES.md) (technical audit), [`SEO-CARE-GUIDES-PLAN.md`](./SEO-CARE-GUIDES-PLAN.md)
> (content strategy), [`SEO-CARE-GUIDES-ACTIONS.md`](./SEO-CARE-GUIDES-ACTIONS.md) (task list), and the
...
- [ ] **JSON-LD per guide:** `Article` + `FAQPage` + `BreadcrumbList` (hub: `CollectionPage`/`ItemList`).
...
- [`SEO-FIXES.md`](./SEO-FIXES.md) — full technical audit + organic strategy (June 18, 2026).
- [`SEO-CARE-GUIDES-PLAN.md`](./SEO-CARE-GUIDES-PLAN.md) — care-guides strategy, keyword maps, GEO playbook.
- [`SEO-CARE-GUIDES-ACTIONS.md`](./SEO-CARE-GUIDES-ACTIONS.md) — original P0–P2 task list.
