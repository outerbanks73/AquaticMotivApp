    ...
    <div className="min-h-screen bg-gradient-to-b from-leaf-50 via-white to-leaf-50">
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-12 sm:py-16">
          <nav aria-label="Breadcrumb" className="text-sm text-leaf-200">
            <ol className="flex flex-wrap items-center gap-1.5">
              <li>
                <Link href="https://aquaticmotiv.com/a/freshwater-aquatic-planted-tank-guide/plants" className="hover:text-white hover:underline">
                  Plants
                </Link>
              </li>
              <li aria-hidden>/</li>
      ...
      <main className="mx-auto max-w-3xl px-4 pb-24 pt-10">
        ...
        <div className="mt-12 rounded-2xl bg-leaf-950 p-6 text-white sm:p-8">
          ...
          <Link
            href={`https://aquaticmotiv.com/a/freshwater-aquatic-planted-tank-guide/finder${facet.finderParams ? `?${facet.finderParams}` : ""}`}
          ...
          <section aria-labelledby="siblings" className="mt-12">
            ...
            <ul className="mt-3 flex flex-wrap gap-2">
              {siblings.map((sibling) => (
                <li key={sibling.slug}>
                  <Link
                    href={`https://aquaticmotiv.com/a/freshwater-aquatic-planted-tank-guide/plants/${sibling.slug}`}
